/*------------------------------------------------------------------------------
	...
	PLEASE KEEP THIS CODE IN LESS THAN 0XFF LINES. EACH LINE MAY CONTAIN ONE BUG !!! <- This comment speaks to me on an emotional level
...
int DHTgpio = 23;				// Bree's default DHT gpio pin = 23
int LEDgpio = 2;				// Bree's default LED gpio pin = 2
float humidity = 0.;
float temperature = 0.;

// == set the DHT user pin=========================================

void setDHTgpio( int gpio )
{
	DHTgpio = gpio;
}
// == set the LED user pin====== // Bree custom created for LED  (not currently used)=======
